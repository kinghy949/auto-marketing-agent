...
| P1-034 | HITL 队列 Postgres 后端 | ✅ | P1-053 | `hitl/postgres_queue.py` + `migrations/003_hitl_items.sql`;approval / variant 完整 dump 成 JSONB,brand_guardrails 走 TEXT[];enqueue 幂等走 ON CONFLICT DO NOTHING |
